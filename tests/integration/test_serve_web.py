...
class TestServeWeb:
    ...
    def test_serve_starts_uvicorn_when_web_enabled(
        ...
        with (
            patch("hestia.commands.serve.uvicorn.Server") as mock_server_class,
            patch("hestia.platforms.runners.run_telegram"),
            patch("hestia.platforms.runners.run_matrix"),
        ):
    ...
    def test_serve_skips_web_when_disabled(
        self, cli_runner: CliRunner, tmp_path: Path
    ) -> None:
