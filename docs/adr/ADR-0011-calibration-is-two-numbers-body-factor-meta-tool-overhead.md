# ADR-0011: Calibration is two numbers (body factor + meta-tool overhead)

- **Status:** Accepted
- **Date:** 2026-04-09
- **Context:** ADR-0009 accepted a single mean ratio (1.68) as the correction factor
...
- **Consequences:** Budget calculation is now directionally safe (over-counts,
  ...
  request, the calibration needs to be extended. Supersedes ADR-0009.
