...
class HestiaConfig(_ConfigFromEnv):
    ...
    system_prompt: str = (
        ...
        "3. When the user asks a conversational question, reply directly without calling "
        "tools — EXCEPT: if the user shares a durable personal fact (identity, family, "
        "living situation, preferences, corrections — rule 6), call save_memory first, "
        "then reply.\n"
        ...
        "what to include/exclude, family, living situation), immediately use save_memory "
        "to persist it. These "
