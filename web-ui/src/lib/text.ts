export const TEXT = {
  ...
  knowledge: {
    ...
    sessionsEmptyTitle: 'No sessions found',
  ...
  scheduler: {
    ...
    emptyDescription:
      'Create a scheduled task to run prompts or URLs on a recurring basis.',
  ...
  styleProfile: {
    ...
    emptyTitle: 'No style metrics',
    emptyDescription:
      'No style metrics for this identity yet. Hestia builds a style profile over time.',
  ...
  proposals: {
    ...
    tabPending: 'Pending',
    tabHistory: 'History',
    pendingEmptyTitle: 'No pending proposals',
