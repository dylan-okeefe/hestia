...
- Name: config.spec.ts >> currently active preset is visually highlighted
- Location: playwright/config.spec.ts:28:1
...
Locator: locator('div:has(> h3:has-text("Developer"))')
Expected: "rgb(25, 118, 210)"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toHaveCSS" with timeout 5000ms
  - waiting for locator('div:has(> h3:has-text("Developer"))')
