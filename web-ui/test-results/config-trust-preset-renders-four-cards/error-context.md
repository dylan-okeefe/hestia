...
- Name: config.spec.ts >> trust preset renders four cards
- Location: playwright/config.spec.ts:14:1
...
Locator: locator('h3:has-text("Paranoid")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h3:has-text("Paranoid")')
