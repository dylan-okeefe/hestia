...
echo ""
echo "User-level services (unified server + GPU watchdog):"
echo "  systemctl --user enable --now hestia-serve.service"
echo "  systemctl --user enable --now gpu-watchdog.timer"
